...
1. Abra https://ibsala.com.br
2. Toque em "Entrar com Google", com a mesma conta de sempre
3. Adicione suas matérias em Configurações
4. Ative as notificações push: o aviso com a sala chega uns 50 minutos antes de cada aula
